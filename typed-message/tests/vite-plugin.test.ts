...
describe('typedMessagePlugin', () => {
  ...
  it.each(['json5', 'jsonc'])(
    'prioritizes JSON5/JSONC files over JSON files with same base name',
    async (ext) => {
  ...
  it.each(['json5', 'jsonc'])(
    'handles mixed JSON and JSON5/JSONC files correctly',
    async (ext) => {
